#ifndef UCPROJECT_CONFIG_MBEDTLS_H_
#define UCPROJECT_CONFIG_MBEDTLS_H_

#include "project_config.h"

///* System support for time. */
...
#if defined(CONFIG_MBEDTLS_FS_IO)
...
/* Enable legacy usage of ECDH context */
